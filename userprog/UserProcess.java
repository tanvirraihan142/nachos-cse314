...
public class UserProcess {
    ...
    public UserProcess() {
        ...
        //increases the active process count 
        UserKernel.activeProcessSem.P();
        UserKernel.activeProcesses++;
        UserKernel.activeProcessSem.V();
    ...
    public void handleExit(int exit) {
        ...
        UserKernel.activeProcessSem.P();
        if (UserKernel.activeProcesses == 1) {
    ...
    public static final int syscallHalt = 0,
            syscallExit = 1,
            syscallExec = 2,
            syscallJoin = 3,
            syscallCreate = 4,
