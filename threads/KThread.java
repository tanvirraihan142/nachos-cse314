...
public class KThread {
	...
	toBeDestroyed = currentThread;
        ...
        //task 1 start
        ThreadQueue currentJoinQ = currentThread.joinQueue;
        if (currentJoinQ!=null){
            KThread t = currentJoinQ.nextThread();
            while(t!=null){
                t.ready();
                t=currentJoinQ.nextThread();
            }
        }
        //task 1 finish
    ...
    private static ThreadQueue joinQueue = null;            //task 1
